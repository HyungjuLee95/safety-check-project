...
import { LogOut, ClipboardList, Calendar, ArrowLeft } from 'lucide-react';

const HomeView = ({ user, onStart, onMyRecords, onLogout }) => (
  <div className="flex flex-col gap-6 pt-4 animate-in slide-in-from-bottom-4 duration-500">
    ...
    <div className="grid grid-cols-2 gap-3">
      <div className="p-5 bg-blue-50 rounded-[2rem] border border-blue-100">
        ...
        <p className="text-lg font-black text-slate-800">{new Date().toISOString().split('T')[0]}</p>
      </div>
